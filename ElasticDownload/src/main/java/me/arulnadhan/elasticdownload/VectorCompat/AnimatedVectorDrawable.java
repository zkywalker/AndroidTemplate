package me.arulnadhan.elasticdownload.VectorCompat;
...
import me.arulnadhan.elasticdownload.R;
...
public class AnimatedVectorDrawable extends DrawableCompat implements Animatable, Tintable {
    ...
    public void inflate(Context c, Resources res, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme)
    ...
    Animator getPathAnimator(Context c, Resources res, Resources.Theme theme, int id, float pathErrorScale) {
