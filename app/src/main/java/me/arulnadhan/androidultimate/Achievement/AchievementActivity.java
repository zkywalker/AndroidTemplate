...
public class AchievementActivity extends ThemeBaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (i) {
            case 0:
                ...
                break;
            case 1:
                new AchievementUnlocked(this).setTitle("Transhumanist").setSubTitle("Augmented").setTypeface(Typeface.createFromAsset(getApplicationContext().getAssets(), "mario.TTF")).setIcon(getDrawableFromRes(R.drawable.mario)).setBackgroundDrawable(getDrawableFromRes(R.drawable.custom_bg)).isLarge(true).build().show();
                break;
            case 2:
            ...
            case 5:
                ...
                break;
            case 6:
                final AchievementUnlocked achievementUnlocked = new AchievementUnlocked(this).setTitle("AruLNadhaN is calling...").setTitleColor(0xff000000).setSubTitle("Tap to reject").setSubtitleColor(0x80000000).setIcon(getDrawableFromRes(R.drawable.calling)).isPersistent(true).build();
