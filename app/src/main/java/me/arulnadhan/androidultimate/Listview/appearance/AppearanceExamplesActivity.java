...
import me.arulnadhan.androidultimate.Listview.MyListAdapter;
...
public class AppearanceExamplesActivity extends MyListActivity implements ActionBar.OnNavigationListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        Snackbar.make(getListView(), "Press menu for More options", Snackbar.LENGTH_LONG)
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.list_appearance, menu);
        return true;
    }
