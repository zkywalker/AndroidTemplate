 ...
 */
public class PickerActivity extends ThemeBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Intent Picker");
        ...
        shareButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                IntentPickerSheetView.ActivityInfo customInfo = new IntentPickerSheetView.ActivityInfo(customDrawable, "Custom mix-in", PickerActivity.this, BottomsheetActivity.class);
