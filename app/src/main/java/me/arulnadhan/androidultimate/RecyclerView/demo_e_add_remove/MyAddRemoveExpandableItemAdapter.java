...
class MyAddRemoveExpandableItemAdapter
    ...
    public MyAddRemoveExpandableItemAdapter(
    ...
    public MyGroupViewHolder onCreateGroupViewHolder(ViewGroup parent, int viewType) {
        ...
        final View v = inflater.inflate(R.layout.rv_list_group_item_with_add_remove_buttons, parent, false);
    ...
    public MyChildViewHolder onCreateChildViewHolder(ViewGroup parent, int viewType) {
        final LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        final View v = inflater.inflate(R.layout.rv_list_item_with_add_remove_buttons, parent, false);
