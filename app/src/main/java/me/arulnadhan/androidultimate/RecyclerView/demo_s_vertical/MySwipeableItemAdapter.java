...
class MySwipeableItemAdapter
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        final View v = inflater.inflate(R.layout.rv_list_item_v, parent, false);
    ...
    private static class SwipeUpResultAction extends SwipeResultActionMoveToSwipedDirection {
        ...
        SwipeUpResultAction(MySwipeableItemAdapter adapter, int position) {
            mAdapter = adapter;
            mPosition = position;
        }
    ...
    private static class SwipeDownResultAction extends SwipeResultActionRemoveItem {
        ...
        SwipeDownResultAction(MySwipeableItemAdapter adapter, int position) {
            mAdapter = adapter;
            mPosition = position;
        }
