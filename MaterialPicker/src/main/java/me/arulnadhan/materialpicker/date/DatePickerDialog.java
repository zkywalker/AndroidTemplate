...
import me.arulnadhan.materialpicker.HapticFeedbackController;
import me.arulnadhan.materialpicker.R;
import me.arulnadhan.materialpicker.TypefaceHelper;
import me.arulnadhan.materialpicker.Utils;
...
/**
    ...
    public class DatePickerDialog extends DialogFragment implements
            OnClickListener, me.arulnadhan.materialpicker.date.DatePickerController {
        ...
        private me.arulnadhan.materialpicker.date.AccessibleDateAnimator mAnimator;
        ...
        private me.arulnadhan.materialpicker.date.DayPickerView mDayPickerView;
        private me.arulnadhan.materialpicker.date.YearPickerView mYearPickerView;
        ...
        private me.arulnadhan.materialpicker.date.SimpleDayPickerView mDayPickerViewEnd;
        private me.arulnadhan.materialpicker.date.YearPickerView mYearPickerViewEnd;
        private me.arulnadhan.materialpicker.date.AccessibleDateAnimator mAnimatorEnd;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            final Activity activity = getActivity();
            mDayPickerView = new me.arulnadhan.materialpicker.date.SimpleDayPickerView(activity, this);
            mYearPickerView = new me.arulnadhan.materialpicker.date.YearPickerView(activity, this);
            mDayPickerViewEnd = new me.arulnadhan.materialpicker.date.SimpleDayPickerView(activity, this);
            mYearPickerViewEnd = new me.arulnadhan.materialpicker.date.YearPickerView(activity, this);
            ...
            mAnimator = (me.arulnadhan.materialpicker.date.AccessibleDateAnimator) view.findViewById(R.id.animator);
            mAnimatorEnd = (me.arulnadhan.materialpicker.date.AccessibleDateAnimator) view.findViewById(R.id.animator_end);
            ...
            tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
                ...
                public void onTabChanged(String tabId) {
                    me.arulnadhan.materialpicker.date.MonthAdapter.CalendarDay calendarDay;
                    if(tabId=="start"){
                        calendarDay = new me.arulnadhan.materialpicker.date.MonthAdapter.CalendarDay(mCalendar.getTimeInMillis());
                        mDayPickerView.goTo(calendarDay,true,true,false);
                    }
                    else{
                        calendarDay = new me.arulnadhan.materialpicker.date.MonthAdapter.CalendarDay(mCalendarEnd.getTimeInMillis());
        ...
        @Override
        public me.arulnadhan.materialpicker.date.MonthAdapter.CalendarDay getSelectedDay() {
            return new me.arulnadhan.materialpicker.date.MonthAdapter.CalendarDay(mCalendar);
        }
